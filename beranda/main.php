            ...
            <div class="container">
                <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
                    <div class="col-md-4 d-flex align-items-center">
                        ...
                        <span class="mb-3 mb-md-0 text-muted">&copy; Copyright 2022 <br>SISTEM INFORMASI MANAJEMEN SEKOLAH PAUD AL-FAZIR
                            Powered by Amir. Created with ❤️ by AmiGos~</span>
                    </div>
                    ...
                    <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
                        ...
                        <li class="ms-3"><a class="text-muted" href="https://id-id.facebook.com/"><svg class="bi" width="24" height="24">
