            ...
            <div class="container">
              ...
              <div class="carousel-caption text-start">
                ...
                <p>Selamat datang di Official Website Sekolah PAUD AL - FAZIR, yang merupakan wujud dari kesungguhan
                  kami untuk membangun komunikasi interaktif demi meningkatkan kualitas pendidikan di Sekolah ini. </p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="container">
            <div class="container">
              <div class="carousel-caption">
                ...
                <p><a class="btn btn-lg btn-primary" href="#">Selengkapnya</a></p>
              </div>
            </div>
          </div>
        </div>
  ...
  ================================================== -->
    ...
    <div class="container marketing">
      ...
      <div class="row featurette">
        <div class="col-md-7">
          <h2 class="featurette-heading fw-normal lh-1">PERINGATAN HUT REPUBLIK INDONESIA DI PAUD AL-FAZIR</h2>
          <p class="lead">Some great placeholder content for the first featurette here. Imagine some exciting prose
            here.</p>
          <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            <button class="btn btn-secondary me-md-2" type="button">Selengkapnya</button>
          </div>
        </div>
        <div class="col-md-5">
